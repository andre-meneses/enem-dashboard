...
def streamlit_grade_plot():
    ...
    var_dict = {'Matemática':'NU_NOTA_MT','Ciências das Natureza':'NU_NOTA_CN','Ciências Humanas':'NU_NOTA_CH','Linguagens':'NU_NOTA_LC', 'Redação':'NU_NOTA_REDACAO'}

    col1, col2= st.columns(2)

    variables = [key for key in var_dict.keys()]
...
def streamlit_income_plot():
    var_dict = {'Renda':'Q006'}
    # dicts = {'Q006':tp_faixa_etaria_dict, 'TP_ESCOLA':tp_cor_raca_dict}
